            ...
            <div class="panel panel-info" >
                    ...
                    <div style="padding-top:30px" class="panel-body" >
                        ...
                        <div style="display:none" id="register-alert" class="alert alert-danger col-sm-12"></div>
                          <!--  -->  
                        <form id="registerform" class="form-horizontal" role="form" method="post" action="{{ url('/app') }}"> 
				...
				<span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                            ...
                            <div style="margin-bottom: 25px" class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                        <input id="username" type="text" class="form-control" name="email" value="" placeholder="email">                                        
                                    </div>
				 ...
				 <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
                                ...
                                <div style="margin-bottom:50px" class="form-group">
                                    ...
                                    <div class="col-sm-12 controls">
                                        ...
                                        <a id="btn-register" href="home" class="btn btn-success" value="Register" type="submit"> Register  </a>
